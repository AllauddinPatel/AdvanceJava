...
public class ComparatorDemo {
    ...
    public static void main(String[] args) {
        ComparatorDemo obj = new ComparatorDemo(1, "Allu", "Pune");
        ComparatorDemo obj1 = new ComparatorDemo(3, "Rahul", "Pune");
        ComparatorDemo obj2 = new ComparatorDemo(2, "Anil", "Pune");
